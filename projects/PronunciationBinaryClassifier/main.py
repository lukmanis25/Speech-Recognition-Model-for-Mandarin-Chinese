...
from tf_keras.src.callbacks import EarlyStopping, TensorBoard
...
#Callbacks
early_stopping = EarlyStopping(monitor='val_loss', patience=5, restore_best_weights=True) #prevent overfitting
tensorboard_callback = TensorBoard(log_dir=train_logs_path, histogram_freq=1, write_graph=True, write_images=True)
