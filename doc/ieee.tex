...
\begin{figure}[hbtp]
    ...
    \label{CNNPELoss} % ``Fig.~\ref{fig_ToneCNN_Mat}''
    \end{figure}
...
\begin{figure}[hbtp]
    ...
    \label{CNNPEAcc} % ``Fig.~\ref{fig_ToneCNN_Mat}''
    \end{figure}
...
\begin{figure}[hbtp]
    ...
    \label{CNNPE3Loss} % ``Fig.~\ref{fig_ToneCNN_Mat}''
    \end{figure}
...
\begin{figure}[hbtp]
    ...
    \label{CNNPE3Acc} % ``Fig.~\ref{fig_ToneCNN_Mat}''
    \end{figure}
...
\begin{figure}[hbtp]
    ...
    \label{STLoss} % ``Fig.~\ref{fig_ToneCNN_Mat}''
    \end{figure}
...
\begin{figure}[hbtp]
    ...
    \label{STLossFT} % ``Fig.~\ref{fig_ToneCNN_Mat}''
    \end{figure}
